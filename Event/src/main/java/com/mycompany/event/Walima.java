...
public class Walima extends Wedding implements ActionListener{
    ...
    double discount;
     ...
     Walima(){
       try{  
        ...
        p.setPreferredSize(new Dimension(700,80));
        ...
        c3 = new JCheckBox("Bridal Dress_102000");
        p.add(c3);
        c3.setForeground(Color.white);
        c3.setBackground(Color.BLUE);
       // c3.addActionListener(this);
        
        l = new JLabel("Select the activities for your Valima Event");
        p2.add(l);
     ...
     @Override
      public void actionPerformed(ActionEvent e){
       ...
       if(e.getSource()==b){
            ...
            FileWriter w;
              try {
                  w = new FileWriter("C:\\Users\\Momina\\Desktop\\Wedding Details", true);
                  w.write("Valima details:\n");
           ...
           if(c.isSelected()){
            ...
            discount();
            w.write("Total amount after 10% discount : Rs.  "
                        +String.valueOf(discount)+"\n");
            w.write("_______________________________________\n");
            w.close();
            
            JOptionPane.showMessageDialog(f, "Sprinkle Event Solutions appreciate your time and contact to you in 1-2 days");
            f.dispose();
            new EventManagement();
       
              } catch (IOException ex) {
                  Logger.getLogger(Walima.class.getName()).log(Level.SEVERE, null, ex);
              }
       } 
    ...
    @Override
      public void discount(){
          try{  
             double sum = total*  0.1;
             discount = total-sum;
           l17.setText("Congratulations!");
           l18.setText ("You got 10% discount on Valima.");
    ...
    public void setDanceFloorAmount(double f) {
     ...
     public static void main(String args[]){
         Walima mehndi = new Walima();
          mehndi.setPopcorn(3500);
         mehndi.setIceCreamBar(7800);
